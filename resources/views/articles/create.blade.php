    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('article.create') }}" aria-label="createArticle">
                        @csrf
                        <div class="form-group row">
                            <label for="slug" class="col-4 col-md-2 col-form-label">Name URL</label>
                            <div class="col-8 col-md-10">
                                <input id="slug" type="text" class="form-control{{ $errors->has('slug') ? ' is-invalid' : '' }}" name="slug" value="{{ old('slug') }}" placeholder="test-name-url" required autofocus>
                                @if ($errors->has('slug'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8 col-md-10">
                                <input id="title_th" type="text" class="form-control{{ $errors->has('title_th') ? ' is-invalid' : '' }}" name="title_th" value="{{ old('title_th') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <textarea name="detail_th" id="editor" row="10">{{ old('detail_th') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="detail_en" id="editor1" row="10">{{ old('detail_en') }}</textarea>
