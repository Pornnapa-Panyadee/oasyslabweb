            ...
            <ul class="sidebar-menu scrollable pos-r">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="sidebar-link" href="{{ route('users.createUser') }}">Create User</a></li>
                        <li><a class="sidebar-link" href="{{ route('users') }}">List User</a></li>
                        <li><a class="sidebar-link" href="{{ route('users.deletedUser') }}">Restore User</a></li>
                    </ul>
                </li>
                @endif
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="sidebar-link" href="{{ route('members.create') }}">Create Members</a></li>
                        <li><a class="sidebar-link" href="{{ route('members') }}">List Members</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="sidebar-link" href="{{ route('article.createArticle') }}">Create Articles</a></li>
                        <li><a class="sidebar-link" href="{{ route('article') }}">List Articles</a></li>
                    </ul>
                </li>

                <li class="nav-item">
                    <a class="sidebar-link" href="{{ route('images') }}">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <!-- <li><a class="sidebar-link" href="{{ route('projects.create') }}">Create Main Projects</a></li> -->
                        <li><a class="sidebar-link" href="{{ route('projects') }}">List Projects</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="sidebar-link" href="{{ route('publications.create') }}">Create Publications</a></li>
                        <li><a class="sidebar-link" href="{{ route('publications') }}">List Publications</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="sidebar-link" href="{{ route('settings.banner') }}">Banner</a></li>
                        <li><a class="sidebar-link" href="{{ route('settings.detail') }}">About Us & Contact</a></li>
                        <li><a class="sidebar-link" href="{{ route('settings.color') }}">Colors</a></li>
                    </ul>
                </li>
            </ul>
        </div>
