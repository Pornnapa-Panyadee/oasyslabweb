    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('projects.editProject',['id'=>$project->id]) }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-sm-12 col-md-4 text-center">
                                <div class="form-group" id="image-preview">
                                    <img class="w-100" src="{{ asset($project->images->path)}}" alt="">
                                </div>
                            ...
                            <div class="col-sm-12 col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="th_name" placeholder="ชื่อ" name="th_name" value="{{ old('th_name') == null? $project->th_name: old('th_name')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="en_name" placeholder="Name" name="en_name" value="{{ old('en_name') == null? $project->en_name: old('en_name')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="th_description" rows="3" name="th_description">{{ old('th_description') == null? $project->th_description: old('th_description') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="en_description" rows="3" name="en_description">{{ old('en_description') == null? $project->en_description: old('en_description') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="order_no" placeholder="ลำดับการโชว์" name="order_no" value="{{ old('order_no') == null? $project->order_no: old('order_no') }}">
                                    @if ($errors->has('order_no'))
                                        <small class="form-text text-danger">{{ $errors->first('order_no') }}</small>
                                    @endif
                                </div>
                                <input type="hidden" class="form-control" id="order_no" placeholder="Icon Active Path" name="icon_active" value="{{$project->icon_active}}">
                                <input type="hidden" class="form-control" id="order_no" placeholder="Icon Path" name="icon" value="{{$project->icon}}">
                            </div>
