    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('projects.editSubProject',['id'=>$subproject->id]) }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-sm-12 col-md-4 text-center">
                                <div class="form-group" id="image-preview">
                                    <img class="w-100" src="{{ asset($subproject->images->path)}}" alt="">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="image_id" value="{{$subproject->image_id}}">
                                </div>
                            ...
                            <div class="col-sm-12 col-md-8">
                                <input type="hidden" name="main_id" value="{{$subproject->main_id}}">
                                <div class="form-group">
                                    <label for="th_name">ชื่อ</label>
                                    <input type="text" class="form-control" id="th_name" placeholder="ชื่อ" name="th_name" value="{{ old('th_name') == null? $subproject->th_name: old('th_name')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="en_name" placeholder="Name" name="en_name" value="{{ old('en_name') == null? $subproject->en_name: old('en_name')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="th_description" rows="3" name="th_description">{{ old('th_description') == null? $subproject->th_description: old('th_description') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="en_description" rows="3" name="en_description">{{ old('en_description') == null? $subproject->en_description: old('en_description') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="order_no" placeholder="ลำดับการโชว์" name="order_no" value="{{ old('order_no') == null? $subproject->order_no: old('order_no') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="external_link" placeholder="External link" name="external_path" value="{{ old('external_path') == null? $subproject->external_path: old('external_path') }}">
