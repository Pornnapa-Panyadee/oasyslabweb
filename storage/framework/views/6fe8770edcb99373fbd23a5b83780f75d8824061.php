        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Edit Article</div>
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('article.editArticle',$article->id)); ?>" aria-label="<?php echo e(__('edit')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="form-group row">
                                <label for="slug" class="col-4 col-md-2 col-form-label">Name URL</label>
                                <div class="col-8 col-md-10">
                                    <input id="slug" type="text" class="form-control<?php echo e($errors->has('slug') ? ' is-invalid' : ''); ?>" name="slug" value="<?php echo e(old('slug') == null? $article->slug:old('slug')); ?>" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8 col-md-10">
                                    <input id="title_th" type="text" class="form-control<?php echo e($errors->has('title_th') ? ' is-invalid' : ''); ?>" name="title_th" value="<?php echo e(old('title_th') == null? $article->title_th:old('title_th')); ?>" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8 col-md-10">
                                    <input id="title_en" type="text" class="form-control<?php echo e($errors->has('title_en') ? ' is-invalid' : ''); ?>" name="title_en" value="<?php echo e(old('title_en') == null? $article->title_en:old('title_en')); ?>" required autofocus>
                                ...
                                <div class="col-8 col-md-10">
                                    <select class="form-control<?php echo e($errors->has('type_id') ? ' is-invalid' : ''); ?>" id="type_id" name="type_id">
                                        <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php elseif($type['id'] == $article->type_id && (old('type_id') == '' || old('type_id') == NULL)): ?>
                                                <option value="<?php echo e($type['id']); ?>" selected><?php echo e($type['type']); ?></option>
                                            <?php else: ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8 col-md-10">
                                    <div class="form-group" id="image-preview">
                                        <?php if($article->cover_id): ?>
                                            <img class="w-100" src="<?php echo e(asset($article->images->path)); ?>" alt="">
                                        <?php else: ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <textarea name="detail_th" id="editor" row="10"><?php echo e(old('detail_th') == null? $article->detail_th:old('detail_th')); ?></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="detail_en" id="editor1" row="10"><?php echo e(old('detail_en') == null? $article->detail_en:old('detail_en')); ?></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8 col-md-10">
                                    <input type="text" class="form-control" id="order_no" placeholder="ลำดับการโชว์" name="order_no" value="<?php echo e(old('order_no') == null? $article->order_no:old('order_no')); ?>">
                                </div>
                            </div>
