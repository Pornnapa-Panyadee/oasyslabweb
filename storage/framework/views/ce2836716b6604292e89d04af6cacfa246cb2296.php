    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('projects.createSubProject')); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-8">
                                <input type="hidden" name="main_id" value="<?php echo e($id); ?>">
                                <div class="form-group">
                                    <label for="th_name">ชื่อ</label>
                                    <input type="text" class="form-control" id="th_name" placeholder="ชื่อ" name="th_name" value="<?php echo e(old('th_name')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="en_name" placeholder="Name" name="en_name" value="<?php echo e(old('en_name')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="th_description" rows="3" name="th_description"><?php echo e(old('th_description')); ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="en_description" rows="3" name="en_description"><?php echo e(old('en_description')); ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="order_no" placeholder="ลำดับการโชว์" name="order_no" value="<?php echo e(old('order_no')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="order_no" placeholder="External link" name="external_path" value="<?php echo e(old('external_path')); ?>">
